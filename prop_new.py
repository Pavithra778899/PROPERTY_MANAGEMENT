...
API_TIMEOUT = 50000
CORTEX_SEARCH_SERVICES = 'AI.DWH_MART.PROPERTYMANAGEMENTSEARCH'  # New service name
...
def query_cortex_search_service(query):
    ...
    try:
        ...
        cortex_search_service = (
            root.databases[db]
            .schemas[schema]
            .cortex_search_services["PROPERTYMANAGEMENTSEARCH"]
        )
        ...
        search_col = service_metadata[0].get("search_column", "content")
        context_str = ""
...
if not st.session_state.authenticated:
    ...
    def is_structured_query(query: str):
        structured_patterns = [
            r'\b(count|number|where|group by|order by|sum|avg|max|min|total|how many|which|show|list|percentage|by|budget|supplier|billing|customer)\b',
            r'\b(property|properties|tenant|tenants|lease|leases|rent|occupancy|maintenance|billing|payment|supplier|budget|customer)\b'
        ]
    ...
    with st.sidebar:
        ...
        if st.session_state.get("show_sample_questions", False):
            ...
            sample_questions = [
                ...
                "Give me the  payment amount by state and occupancy status?",
