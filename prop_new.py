...
from snowflake.core import Rootimport streamlit as st
import json
import re
import requests
import snowflake.connector
...
if "query" not in st.session_state.query:
    st.session_state.query = None
if "previous_query" not in st.session_state.previous_query:
    st.session_state.previous_query = None
if "previous_sql" not in st.session_state.previous_sql:
    st.session_state.previous_sql = None
if "previous_results" not in st.session_state.previous_results:
    st.session_state.previous_results = None
if "show_sample_questions" not in st.session_state.show_sample_questions:
