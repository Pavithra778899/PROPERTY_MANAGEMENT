...
def is_structured_query(query: str):
        structured_patterns = [
            ...
            r'\b(vendor|supplier|requisition|purchase order|po|organization|department|buyer|delivery|received|billed|rejected|percentage|billing|payment|Suppliers)\b'
        ]
